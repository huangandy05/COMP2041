...
#########################################
# pigs-checkout : error testing and functionality #
#########################################
...
pigs-checkout > "$actual_output" 2>&1
echo "pigs-checkout: error: pigs repository directory .pig not found" > "$expected_output"
